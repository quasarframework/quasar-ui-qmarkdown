...
- The app extension is Vite-only and requires `@quasar/app-vite` >=3.0.0-beta.38.
...
| Vue                           | Vue 3                     |
| Quasar                        | Quasar 2                  |
| Quasar CLI                    | `@quasar/app-vite` >=3.0.0-beta.38 |
...
- Install it only in apps using `@quasar/app-vite` >=3.0.0-beta.38.
