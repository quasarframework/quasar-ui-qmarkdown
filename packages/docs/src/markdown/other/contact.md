...
As a first step, it's always good to search open and closed issues on the QMarkdown [GitHub repo](https://github.com/quasarframework/quasar-ui-qmarkdown).
...
Answers to the most common questions regarding QMarkdown can be found in the [QMarkdown FAQ](/developing/faq).
...
If you have a specific fix or contribution, you can generate a pull request on the [QMarkdown repo](https://github.com/quasarframework/quasar-ui-qmarkdown). Use the active development branch for the version you are targeting.
