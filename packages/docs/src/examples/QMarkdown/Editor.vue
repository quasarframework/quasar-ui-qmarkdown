<template>
  <div class="q-pa-md q-gutter-sm">
    <q-toggle v-model="noHtml" label="Disable HTML" />
    <q-toggle v-model="noLink" label="Disable Link" />
    <q-toggle v-model="noLinkify" label="Disable Linkify" />
    <q-toggle v-model="noTypographer" label="Disable Typographer" />
    <q-toggle v-model="noBreaks" label="Disable Breaks" />
    <q-toggle v-model="noHighlight" label="Disable Highlight" />
    <q-toggle v-model="noSubscript" label="Disable Subscript" />
    <q-toggle v-model="noEmoji" label="Disable Emoji" />
    <q-toggle v-model="noSuperscript" label="Disable Superscript" />
    <q-toggle v-model="noFootnote" label="Disable Footnote" />
    <q-toggle v-model="noDeflist" label="Disable Deflist" />
    <q-toggle v-model="noAbbreviation" label="Disable Abbreviation" />
    <q-toggle v-model="noInsert" label="Disable Insert" />
    <q-toggle v-model="noMark" label="Disable Mark" />
    ...
    <div class="q-pa-md q-gutter-sm fit">
      ...
      <q-splitter v-model="splitterModel" style="height: 500px">
        ...
        <template #before>
          <div class="q-pa-md">
            <textarea v-model="markdown" :rows="20" class="fit q-pa-sm" />
          </div>
        </template>
