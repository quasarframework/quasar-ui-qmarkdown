...
To contribute a component to QMarkdown, start by opening a [GitHub Issue](https://github.com/quasarframework/quasar-ui-qmarkdown/issues). Include a detailed description in which you:
