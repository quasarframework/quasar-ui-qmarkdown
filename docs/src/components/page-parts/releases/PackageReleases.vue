  ...
  setup (props) {
    ...
    function parse (body) {
      ...
      content = content
        ...
        .replace(/```\n/g, '</code>')
        .replace(/\`(.*?)\`/g, '<code class="q-markdown--token">$1</code>')
        .replace(/#([\d]+)/g, '<a class="markdown-link" href="https://github.com/quasarframework/quasar-ui-qmarkdown/issues/$1" target="_blank">#$1</a>')
